...
echo "ffmpeg -i /Users/mikekotsch/Documents/Programming/snippets/_old/inception.avi -ss ${start} -t ${diff} -vcodec copy -acodec copy test.avi"
ffmpeg -i /Users/mikekotsch/Documents/Programming/snippets/_old/inception.avi -ss ${start} -t ${diff} -vcodec copy -acodec copy test.avi
